...
public class SimpleMessageResolver implements MessageResolver {
	...
	static final ResourceBundle.Control CONTROL = ResourceBundle.Control
			.getControl(ResourceBundle.Control.FORMAT_PROPERTIES);

	final String baseName;

	public SimpleMessageResolver() {
		this("ninja.siden.okite.Messages");
	}

	public SimpleMessageResolver(String baseName) {
		super();
